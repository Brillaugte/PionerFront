...
import styles from "./zero-liq.module.css";
...
const ZeroLiq = () => {
  ...
  return (
    <div className={styles.zeroliq}>
      <b className={styles.microderivLlc}>© 2023 Microderiv LLC</b>
      <img className={styles.image40Icon} alt="" src="/image-409@2x.png" />
      <NavigationBar1
      ...
      />
      <div className={styles.zeroliqChild} />
      <div className={styles.zeroliqItem} />
      <Footer
      ...
      />
      <div className={styles.zeroliqInner} />
