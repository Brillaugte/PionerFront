  ...
  return (
    <div className={styles.termsOfUse}>
      ...
      <div className={styles.termsOfUseContainer}>
        ...
        <p className={styles.p}>Effective Date: 07 June 2023</p>
        <p className={styles.p}></p>
        <p className={styles.p}>1. Welcome to Aave.com and the Interface!</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          These Terms of Use ("Terms") govern your access to and use of both the
          Pioner.com website (referred to as "Pioner.com") and App.Pioner.com
          interface (referred to as the “Interface") collectively referred to as
          the "Services." The Services are brought to you by the Pioner
          Companies ("we," "us," or "our").
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          Pioner.com provides information and resources about the fundamentals
          of the decentralized non-custodial liquidity protocol called the
          Pioner Protocol, comprised of open-source self-executing smart
          contracts that are deployed on various permissionless public
          blockchains, such as Ethereum (the "Pioner Protocol" or the
          "Protocol"). The Pioner Companies does not control or operate any
          version of the Pioner Protocol on any blockchain network.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          their self-custodial wallets, interact with the Pioner Protocol.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          (AS DEFINED BELOW) WILL BE RESOLVED BY MANDATORY BINDING ARBITRATION,
          AND YOU WAIVE ANY RIGHT TO A TRIAL BY JURY OR TO PARTICIPATE IN A
          CLASS-ACTION LAWSUIT OR CLASS-WIDE ARBITRATION.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>You are entering into a binding Agreement.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          BY ACCESSING OR USING OUR SERVICES, WHICH INCLUDE OUR VARIOUS
          WEBSITES, INCLUDING, WITHOUT LIMITATION, Pioner.COM AND APP.Pioner.COM
          (AND ANY RESPECTIVE SUBDOMAINS); APPLICATIONS, AND OTHER SERVICES THAT
          LINK TO THESE TERMS, AS WELL AS ANY INFORMATION, TEXT, LINKS,
          GRAPHICS, PHOTOS, AUDIO, VIDEO, OR OTHER MATERIALS STORED, RETRIEVED
          OR APPEARING THEREON, WHETHER ACCESSED THROUGH THE SITE OR OTHERWISE
          (COLLECTIVELY, THE “SERVICES”), YOU ARE ENTERING INTO A BINDING
          AGREEMENT WITH US THAT INCLUDES THESE TERMS, PRIVACY POLICY (FOUND
          HERE), AND OTHER POLICIES REFERENCED HEREIN (COLLECTIVELY, THE
          “AGREEMENT”).
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>Use of the Services</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>We may update the Services and the Terms.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          any part of the Agreement is updated and in effect, you will be bound
          by the Terms if you continue to use the Services. We may, at any time,
          and without liability to you, modify or discontinue all or part of the
          Services (including access to the Services via any third-party links).
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>2. Services</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          Pioner.com is an informational resource about the Protocol; however,
          it is not the exclusive or sole source.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          All information provided in connection with your access and use of the
          Services is intended for informational purposes only. While we strive
          to provide accurate and reliable information, we cannot guarantee the
          accuracy, completeness, or timeliness of the information provided. It
          is possible that the information may be outdated or subject to errors
          or omissions. The codebases of all the versions of the Pioner Protocol
          are maintained on each full network node of the relevant blockchain.
          You should not take, or refrain from taking, any action based on any
          information contained on Pioner.com, including, without limitation,
          the docs.Pioner.com ("Developer Docs") or any other information that
          we make available at any time, including blog posts, data, articles,
          links to third-party content, discord content, news feeds, tutorials,
          tweets, and videos. You further acknowledge and agree that we will not
        ...
        <p className={styles.p}>
          ...
          underlying the Pioner Protocol; we do not have possession, custody or
          control over any cryptoassets, or any user’s funds. You understand
          that when you interact with Pioner Protocol, you retain control over
          your cryptoassets at all times.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          Users use third-party self-custodial wallets to interact with the
          Pioner Protocol; we have no control or guarantee over the wallets.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          To interact with the Pioner Protocol using the Interface, you will
          need to connect and engage with it through your self-custodial wallet.
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>
          We are not intermediaries to the Pioner Protocol transactions.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          Due to the non-custodial and decentralized nature of the technology,
          we are not intermediaries, agents, advisors, or custodians, and we do
          not have a fiduciary relationship or obligation to you regarding any
          other decisions or activities that you affect when using our Services.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          We have no information about all Protocol transactions beyond what is
          publicly available via the blockchain.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          You acknowledge that we do not have information regarding all Pioner
          Protocol transactions beyond what is available or obtainable publicly
          via the blockchain. However, we may collect information regarding the
          users of the Services in accordance with our Privacy Policy.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>There may be associated blockchain fees.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          note that gas fees are non-refundable. We do not provide any services
          to users or deliver, hold, and/or receive payment for cryptoassets. We
          do not receive any fees for any transactions or the Services.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>
          The Interface is hosted on the InterPlanetary File System ("IPFS"), a
          decentralized and distributed network protocol allowing for the
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>3. Assumption of Risk</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          Services, are at your own risk. Please note that we do not have
          control over third-party services. Consequently, we cannot guarantee,
          endorse, or recommend such content or services to users of the
          Interface, nor can we endorse their use for any specific purpose.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          blockchain-based networks will be automatically processed using one or
          more smart contracts. By engaging in transactions using the Services,
          you acknowledge and consent to the automatic processing of all
          transactions in connection with using the Services. You further
          acknowledge and agree that the applicable smart contract will dictate
          how the funds of a transaction and ownership of cryptoassets are
          distributed.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          notify you of all the potential risks of using and accessing our
          Services. You agree to accept these risks and agree that you will not
          seek to hold any Pioner Companies Indemnified Party responsible for
          any consequent losses.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          maintaining the security of your self-custodial wallet. You alone are
          responsible for securing your private keys. We do not have access to
          your private keys. Any unauthorized access to your self-custodial
          wallet by third parties could result in the loss or theft of any
          cryptoasset or funds held in your account and any associated accounts.
          You understand and agree that we have no involvement in, and you will
          not hold us responsible for managing and maintaining the security of
          your self-custodial wallet. The private key associated with the
          self-custodial wallet address from which you transfer cryptoassets or
          the private key associated is the only private key that can control
          the cryptoassets you transfer into the smart contracts.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          suspicion that you are utilizing the Services for illegal purposes, we
        ...
        <p className={styles.p}>
          ...
          to equipment malfunctions, periodic maintenance procedures or repairs,
          causes beyond our control or that we could not reasonably foresee,
        ...
        <p className={styles.p}>
          ...
          unless it is suitable given your circumstances and financial
          resources. By using the Services, you represent that you have been,
          are, and will be solely responsible for conducting your own due
          diligence into the risks of a transaction and the underlying smart
          contracts and cryptoassets.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>4.Taxes</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          and/or payable as a result of using and/or exploiting any cryptoassets
          and interacting with smart contracts. Blockchain-based transactions
          are novel, and their tax treatment is uncertain.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>Ownership</p>
        <p className={styles.p}></p>
        <p className={styles.p}>We grant you a license to use our Services.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          Contingent upon your ongoing compliance with the Agreement, we grant
          you a personal, worldwide, revocable, non-exclusive, and
          non-assignable license to use the software provided to you as part of
          our Services. The only purpose of this license is to allow you to use
          and enjoy the Services solely as permitted by these Terms.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>We own all rights in the Services.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          We own any and all right, title, and interest in and to the Services,
          including, without limitation, any and all copyrights in and to any
          content, code, data, or other materials that you may access or use on
          or through the Services. Except as expressly set forth herein, your
          use of or access to the Services does not grant you any ownership or
          other rights therein.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>We may use and share your feedback.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          free to use or not use any feedback that we receive from you as we see
          fit, including copying and sharing such feedback with third parties,
          without any obligation to you.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>6.Prohibited Content</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          any portion of the Services, including by attempting to reverse
        ...
        <p className={styles.p}>
          ...
          permitted by a smart contract may nevertheless be a violation of our
          Agreement, including these Terms, and the law)
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>7. Disclaimers and Limitations of Liability</p>
        <p className={styles.p}></p>
        <p className={styles.p}>We make no representations or warranties.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          LICENSORS (COLLECTIVELY, THE “PIONER COMPANIES INDEMNIFIED PARTIES”)
          MAKE NO GUARANTEES OF ANY KIND IN CONNECTION WITH THE SERVICES. TO THE
          MAXIMUM EXTENT PERMITTED UNDER APPLICABLE LAW, THE PIONER COMPANIES
          INDEMNIFIED PARTIES DISCLAIM ALL WARRANTIES AND CONDITIONS, WHETHER
          EXPRESS OR IMPLIED, OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
          PURPOSE, OR NON-INFRINGEMENT AND DISCLAIM ALL RESPONSIBILITY AND
          LIABILITY FOR:
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          YOU EXPRESSLY ACKNOWLEDGE THAT THE PIONER COMPANIES INDEMNIFIED
          PARTIES ARE NOT RESPONSIBLE FOR LOSS OR DAMAGE CAUSED BY ANOTHER
          USER’S CONDUCT, UNAUTHORIZED ACTORS, OR ANY UNAUTHORIZED ACCESS TO OR
          USE OF THE SERVICES.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>Limitation of Liability.</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL ANY PIONER
          COMPANIES INDEMNIFIED PARTY BE LIABLE TO YOU FOR ANY LOSS, DAMAGE, OR
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>ANY USER CONDUCT ON THE SERVICES</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>
          IN ADDITION TO THE FOREGOING, NO PIONER COMPANIES INDEMNIFIED PARTY
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>SERVER FAILURE OR DATA LOSS</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          THE MALFUNCTION, UNEXPECTED FUNCTION OR UNINTENDED FUNCTION OF THE
          BLOCKCHAIN, ANY COMPUTER OR CRYPTOASSET NETWORK (INCLUDING ANY WALLET
          PROVIDER), INCLUDING WITHOUT LIMITATION LOSSES ASSOCIATED WITH NETWORK
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>ANY CHANGE IN VALUE OF ANY CRYPTOASSET</p>
        <p className={styles.p}></p>
        <p className={styles.p}>ANY CHANGE IN LAW, REGULATION, OR POLICY</p>
        <p className={styles.p}></p>
        <p className={styles.p}>EVENTS OF FORCE MAJEURE</p>
        <p className={styles.p}></p>
        <p className={styles.p}>ANY THIRD PARTY</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          WHETHER OR NOT THE PIONER COMPANIES INDEMNIFIED PARTIES HAVE BEEN
          INFORMED OF THE POSSIBILITY OF ANY SUCH DAMAGE.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          IN NO EVENT WILL THE PIONER COMPANIES INDEMNIFIED PARTIES’ CUMULATIVE
          LIABILITY TO YOU OR ANY OTHER USER, FROM ALL CAUSES OF ACTION AND ALL
          THEORIES OF LIABILITY EXCEED ZERO U.S. DOLLARS (U.S. $0).
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          UNDER NO CIRCUMSTANCES SHALL ANY PIONER COMPANIES INDEMNIFIED PARTY BE
        ...
        <p className={styles.p}>
          ...
          extent applicable law does not permit Pioner Companies Indemnified
          Parties to disclaim certain warranties or limit certain liabilities,
          the extent of Pioner Companies Indemnified Parties’ liability and the
          scope of any such warranties will be as permitted under applicable
          law.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>8. Indemnification</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          You agree to indemnify, defend, and hold harmless the Pioner Companies
          ...
          Services;(c)Your misuse of the Services, or any smart contract and/or
          script related thereto(d)Your violation of any laws, rules,
          ...
          right, publicity, confidentiality, property, or privacy right;(f)Your
          use of a third-party product, service, and/or website; or (g) any
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>Agreement to Arbitrate</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>Changes</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          PIONER COMPANIES INDEMNIFIED PARTY.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>11. Termination; Cancellation</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>12. Severability</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>13. Assignment</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          The Agreement (including, without limitation, these Terms) may be
          assigned without your prior consent to any Pioner Companies
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>14. Entire Agreement</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
          ...
          you and us and govern your use of the Services, superseding any prior
          ...
          any prior versions of these Terms). Any failure by us to exercise or
          enforce any right or provision of the Agreement (including, without
          limitation, these Terms) shall not constitute a waiver of such right
          or provision.
        </p>
        <p className={styles.p}></p>
        <p className={styles.p}>15. Governing Law</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
        ...
        <p className={styles.p}></p>
        <p className={styles.p}>16. Contact Us</p>
        <p className={styles.p}></p>
        <p className={styles.p}>
